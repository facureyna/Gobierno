...
class C_Conexion extends REST_Controller {
  ...
  //    echo '<pre>';
    ...
    //  $this->load->view('rescatistas');

    }
*/
    public function contestarSolicitud_get($dniRescatista,$estado){
      $respuesta = curl_init();
    ...
    //  $estado = 0;
      ...
      curl_setopt($respuesta, CURLOPT_URL, "http://192.168.1.43/rescatistaAnimales/index.php/rescatista_REST/rescatista");
    ...
    //  echo $response;
    	redirect('campanas_controller/rescatistas');
      }
