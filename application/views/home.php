...
<html lang="en">
  ...
  <body>
    ...
    <main role="main">
      ...
      <div class="jumbotron">
        <div class="container">
          <center><h2 class="display-3">Bienvenido a Gobierno</h2></center>
        </div>
      </div>
   ...
   <main role="main">
	 <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <h2>Campañas</h2>
            <p>Campañas de vacunación antirrábica y esterilizacion gratuita para perros y gatos disponbiles.</p>
            <p><a class="btn btn-secondary" href="#" role="button">Ver detalles &raquo;</a></p>
          </div>
          <div class="col-md-4">
            <h2>Heading</h2>
    ...
    <footer class="container">
      <p><center>&copy;Gobierno Copyright 2019</center></p>
    </footer>
